...
distribution_s = Counter(scores_list_s)
distribution_a = []
distribution_b = []

for i in rounded_scores_a:
    frequencies = Counter(i)
    distribution_a.append(frequencies)
    
for i in rounded_scores_b:
    frequencies = Counter(i)
    distribution_b.append(frequencies)

print('distributions s: ')
print(distribution_s)
print('------------------')
print('distributions a: ')
print(distribution_a)
print('------------------')
print('distributions b: ')
